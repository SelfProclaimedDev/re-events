...
import { getEventChatRef, firebaseObjectsToArrays } from '../../../app/firestore/firebaseService';
            ...
            <Comment.Content>
                ...
                <Comment.Actions>
                    ...
                    {showReplyForm.open && showReplyForm.commentId === comment.id  && 
                        <EventDetailedChatForm eventId={eventId} parentId={comment.id} 
                        ...
                        <Comment.Content>
                            ...
                            <Comment.Actions>
                                ...
                                {showReplyForm.open && showReplyForm.commentId === child.id  && 
                                    <EventDetailedChatForm eventId={eventId} parentId={child.parentId} 
                                    closeForm={handleCloseReplyForm}/>
                                }
                            </Comment.Actions>
                        </Comment.Content>
