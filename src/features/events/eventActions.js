import { CREATE_EVENT , UPDATE_EVENT , DELETE_EVENT, FETCH_EVENTS, LISTEN_TO_EVENT_CHAT, LISTEN_TO_SELECTED_EVENTS, CLEAR_EVENTS } from './eventConstants';
...
export function listenToSelectedEvent(events){
